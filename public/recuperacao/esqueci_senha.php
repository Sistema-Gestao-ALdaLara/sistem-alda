        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <!-- Adicione isso no formulário existente -->
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center">ESQUECI MINHA SENHA</h3>
                                    <p class="text-muted text-center">Entre em contato com a secretaria para redefinir sua senha</p>
                                </div>
                            </div>
                            ...
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <a href="../login.php" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">
                                        Voltar para o Login
                                    </a>
                                </div>
                            </div>

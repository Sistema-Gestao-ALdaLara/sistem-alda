                    ...
                    <form class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block text-center">
                                ...
                                <p class="text-muted">Enviamos um link de redefinição de senha para o seu e-mail.</p>
                                
                                <img src="../libraries/assets/images/auth/email-sent.png" alt="E-mail enviado" width="100">
                                
                                <p class="m-t-20">Caso não encontre, verifique a pasta de spam.</p>
                                
                                <p class="f-w-600 text-right">
                                    <a href="login.htm">Voltar para o login</a>
                                </p>
                            </div>
                        </div>

                        ...
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    ...
                                    <p class="text-muted text-center">Digite sua nova senha abaixo.</p>
                                </div>
                            </div>
                            ...
                            <form action="salvar-nova-senha.php" method="POST">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <input type="password" name="nova-senha" class="form-control" required placeholder="Digite a nova senha">
                                    <span class="form-bar"></span>
                                </div>
                    
                                <div class="form-group form-primary">
                                    <label for="confirmar-senha">Confirme a Senha</label>
                                    <input type="password" name="confirmar-senha" class="form-control" required placeholder="Confirme a nova senha">
                                    <span class="form-bar"></span>
                                </div>

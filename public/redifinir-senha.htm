...
<head>
    <title>RESETAR PASSWORD | ALDA LARA</title>
                            ...
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        ...
                                        <p class="text-muted text-center">Digite seu e-mail para receber um link de redefinição.</p>
                                    </div>
                                </div>
                                
                                <div class="form-group form-primary">
                                    <label for="email-address">E-mail cadastrado</label>
                                    <input type="text" name="email-address" class="form-control" required="" placeholder="Insira Seu Email">
                                    <span class="form-bar"></span>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Enviar Link</button>
                                    </div>
                                </div>
                                <p class="f-w-600 text-right">Voltar para <a href="login.htm">Login.</a></p>
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Obrigado.</p>
                                        <p class="text-inverse text-left"><a href="login.htm"><b class="f-w-600">Voltar para inicio</b></a></p>
                                    </div>
                                    <div class="col-md-2">

				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Iniciar Sessão no Sistema</h2>
						</div>
                        @if ($errors->any())
						...
						<form action="{{route('login.entrar')}}" method="POST">
							...
							<div class="input-group custom">
                                <input type="email" class="form-control form-control-lg" placeholder="Email do Usuário" name="email" value="{{old('email') ?? ""}}">

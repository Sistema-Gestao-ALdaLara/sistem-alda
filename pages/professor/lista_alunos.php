...
try {
    ...
    if ($turmaId) {
        ...
        $turmaValida = array_filter($turmasProfessor, function($turma) use ($turmaId) {
            return $turma['id_turma'] == $turmaId;
        });

        if (!empty($turmaValida)) {
...
// Template HTML
require_once __DIR__ . '/../../includes/common/head.php';
?>
